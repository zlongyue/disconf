...
import com.baidu.disconf.client.core.filetype.impl.DisconfYamlProcessorImpl;
/**
 * 增加yml支持
 * @author knightliao
 *
...
public class FileTypeProcessorUtils {
	...
	public static Map<String, Object> getKvMap(SupportFileTypeEnum supportFileTypeEnum, String fileName)
		...
		} else if (supportFileTypeEnum.equals(SupportFileTypeEnum.YAML)
				|| supportFileTypeEnum.equals(SupportFileTypeEnum.YML)) {
			disconfFileTypeProcessor=new DisconfYamlProcessorImpl();
		} else {
